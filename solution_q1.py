...
def get_all_children(node):
    ...
    #blank tile goes left (number moves right)
    ...
    #blank tile goes right (number moves left)
    ...
    #blank tile goes up (number moves down)
    ...
    #blank tile goes down (number moves up)
